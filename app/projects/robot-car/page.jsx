        ...
        <aside className="space-y-6">
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://github.com/axeboyrocks/Robot_Car" className="text-blue-400 hover:text-blue-300 transition">
                  GitHub Repository
                </a>
              </li>
              <li>
                <a href="https://youtu.be/sSktwMA6k6U" className="text-blue-400 hover:text-blue-300 transition">
                  Demo Video
                </a>
              </li>
            </ul>
